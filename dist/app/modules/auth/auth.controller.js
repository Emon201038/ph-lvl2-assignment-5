...
const login = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    passport_1.default.authenticate('local', (err, user, info) => __awaiter(void 0, void 0, void 0, function* () {
        if (err) {
            return next(new appError_1.default(httpStatus_1.HTTP_STATUS.UNAUTHORIZED, err));
        }
        ;
        if (!user) {
            return next(new appError_1.default(httpStatus_1.HTTP_STATUS.UNAUTHORIZED, info.message));
        }
        ;
        // generate tokens
